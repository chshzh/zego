...
#define WIFI_RECONNECT_DELAY_SEC CONFIG_ZEGO_WIFI_BLE_PROV_RECONNECT_DELAY_SEC
#define WIFI_RECONNECT_RETRY_SEC CONFIG_ZEGO_WIFI_BLE_PROV_RECONNECT_RETRY_SEC
